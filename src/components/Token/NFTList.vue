...
export default {
    ...
    methods: {
        ...
        async onRequest(props) {
            ...
            const nfts = [];
            response.data.results.forEach((nft) => {
                ...
                if (nft.metadata?.attributes) {
                    ...
                    nft.metadata.attributes.forEach((attribute) => {
                        nft.metadata.attributesStr += (typeof attribute.trait_type !== 'undefined')
                            ? `${attribute.trait_type} : `
                            : '';
                        nft.metadata.attributesStr += `${attribute.value}\n`;
                    });
                }
