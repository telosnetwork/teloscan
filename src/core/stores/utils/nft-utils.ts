import { IndexerNftMetadata, NFTSourceTypes, NftSourceType } from 'src/core/types';
import { urlIsAudio, urlIsPicture, urlIsVideo } from 'src/core/stores/utils/media-utils';
