export default {
    ...
    pages: {
        ...
        transaction_sent: 'txn envoyée',
        int_transaction_sent: 'txn interne envoyée',
    ...
    components: {
        ...
        contract_tab: {
            ...
            read: 'Lire',
            write: 'Ecrire',
            read_proxy: 'Proxy de lecture',
            write_proxy: 'Proxy d\'écriture',
            proxy_contract: 'Ceci est un contrat proxy de type {type}, l\'implémentation est : ',
            proxy_contract_tooltip: 'Ce contrat agit comme un proxy pour un autre contrat dans l\'implémentation, permettant de mettre à niveau le comportement de l\'implémentation',
            no_functions_read: 'Aucune fonction de lecture trouvée',
            no_functions_write: 'Aucune fonction d\'écriture trouvée',
            detecting_proxy: 'Détection du contrat proxy...',
            amount: 'Montant',
            value: 'Valeur',
        ...
        export: {
            ...
            date_range_exceeds_limit: 'La plage de dates dépasse la limite d\'un an',
            invalid_block_range: 'Plage de blocs invalide',
            block_range_exceeds_limit: 'La plage de blocs dépasse la limite de {limit} blocs',
        },
    },
    evm_wallet: {
