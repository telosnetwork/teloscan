...
export default {
    ...
    components: {
        ...
        enable_wallet_extensions: 'Habilitar la extensión MetaMask y establecer por defecto `preferir extensiones` en la configuración del monedero del navegador para utilizar el monedero MetaMask.',
