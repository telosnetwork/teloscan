export default {
    ...
    components: {
        ...
        table_pagination: {
            showing_items_from_x_to_y: 'Mostrando itens de { startRow } a { endRow } de um total de { rowsNumber } { entryName }',
            records_per_page: 'Registros por página',
            first: 'Primeiro',
            current_page: 'Página { currentPage } de { totalPages }',
            last: 'Último',
            holders: 'proprietários',
            blocks: 'blocos',
            transactions: 'transações',
        ...
        contract_tab: {
            ...
            read: 'Ler',
            write: 'Escrever',
            read_proxy: 'Leitura Proxy',
            write_proxy: 'Escrita Proxy',
            proxy_contract: 'Este é um contrato proxy do tipo {type}, a implementação é: ',
            proxy_contract_tooltip: 'Este contrato atua como um proxy para outro contrato na implementação, permitindo que o comportamento da implementação seja atualizado',
            no_functions_read: 'Nenhuma função de leitura encontrada',
            no_functions_write: 'Nenhuma função de escrita encontrada',
        ...
        export: {
            ...
            date_range_exceeds_limit: 'O intervalo de datas excede o limite de um ano',
            invalid_block_range: 'Intervalo de blocos inválido',
            block_range_exceeds_limit: 'O intervalo de blocos excede o limite de {limit} blocos',
        },
    },
    evm_wallet: {
