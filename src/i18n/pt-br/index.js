...
export default {
    ...
    components: {
        ...
        disable_wallet_extensions: 'Desative as extensões de carteira ou defina o Brave Wallet como padrão nas configurações da carteira do navegador para usar o Brave Wallet.',
        enable_wallet_extensions: 'Habilite a extensão MetaMask e defina `preferir extensões` como padrão nas configurações da carteira do navegador para usar o MetaMask.',
