export default {
    ...
    components: {
        ...
        transaction: {
            ...
            block: 'Bloco',
            block_tooltip: 'O número do bloco no qual esta transação foi incluída.',
            status: 'Status',
            status_tooltip: 'Indica se a transação foi bem-sucedida, falhou ou está pendente',
            timestamp: 'Data e Hora',
            timestamp_tooltip: 'O momento em que a transação foi confirmada.',
            ...
            from: 'De',
            from_tooltip: 'O endereço que iniciou a transação.',
            to: 'Para',
            to_tooltip: 'O endereço destinatário da transação.',
            value: 'Valor',
            value_tooltip: 'A quantidade de criptomoeda transferida nesta transação.',
            gas_fee: 'Taxa da Transação',
            ...
            gas_limit_n_usage: 'Limite de Gás & Uso por Txn',
            gas_limit_n_usage_tooltip: 'A quantidade máxima de gás que foi permitida para a transação, e a quantidade real de gás utilizada.',
            nonce: 'Nonce',
            ...
            input: 'Entrada',
            input_tooltip: 'Dados enviados junto à transação, normalmente usados para interações com contratos.',
        },
        inputs: {
